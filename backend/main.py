...
from routers import auth, products, cart, orders, admin, payments, addresses, support, returns, wishlist, webhooks, shipping, client_errors, diagnostics
...
def test_email(to: str = ""):
    ...
    if brevo_key:
        ...
        payload = _json.dumps({
            "sender": {"name": "Ammalu Tex", "email": from_email},
            "to": [{"email": target}],
            "subject": "✅ Ammalu Tex — Email Test (Brevo)",
            "htmlContent": (
