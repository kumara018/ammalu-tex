...
PRODUCTS = [
    ...
    {
        "name": "Classic Cotton Half Saree",
        "description": "Traditional cotton half saree with elegant border design. Perfect for college, casual outings and daily wear. Comes with matching blouse piece and dupatta.",
        "price": 899.0,
    ...
    {
        "name": "Silk Half Saree with Zari Border",
        "description": "Elegant silk half saree with rich zari border. Ideal for festivals, temple visits and family functions. Includes matching pavadai and dupatta.",
        "price": 1999.0,
        "compare_price": 2799.0,
        "category": "Half Saree",
        "fabric": "Silk",
    ...
    {
        "name": "Designer Printed Half Saree",
        "description": "Modern printed half saree with contemporary design. Georgette fabric that drapes beautifully. Great for parties and special occasions.",
        "price": 1499.0,
...
def seed():
    db = SessionLocal()
    try:
        admin_email = os.getenv("ADMIN_EMAIL", "ammalutexpartywear@gmail.com")
