    ...
    <div ref={wrap} className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-8 z-50 flex max-h-[calc(100vh-7rem)] w-60 flex-col overflow-y-auto overscroll-contain border border-paper-edge bg-paper py-2"
        >
