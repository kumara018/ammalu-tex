...
/* HEIGHT CAP: `dvh`, NOT `vh`, AND NINE REMS OF CLEARANCE.
              ...
              /*
                 ...
                 */
                className="absolute right-0 top-8 z-50 flex max-h-[min(22rem,calc(100dvh-9rem))] w-60 flex-col overflow-y-auto overscroll-contain border border-paper-edge bg-paper py-2"
        >
