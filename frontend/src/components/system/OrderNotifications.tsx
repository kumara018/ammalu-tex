...
export default function OrderNotifications() {
  ...
  return (
    <section
      ...
      className="mt-[6vh] border-t border-paper-edge pt-8"
    >
      <h2 id="notify-heading" className="text-rule uppercase text-thread">
        Updates on this device
      </h2>

      {state === 'blocked' ? (
        <p className="mt-4 max-w-[54ch] text-graphite-muted">
      ...
      {note && (
        <p role="status" className="mt-4 max-w-[54ch] text-caption text-graphite-faint">
          {note}
        </p>
      )}
    </section>
