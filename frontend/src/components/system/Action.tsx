...
const BASE =
  'group inline-flex items-baseline gap-4 text-caption uppercase transition-colors duration-500 motion-reduce:transition-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-thread';

const TONE = {
  lead: 'border-b border-thread/60 pb-2 text-graphite hover:border-thread',
  quiet: 'text-graphite-faint hover:text-graphite',
} as const;
