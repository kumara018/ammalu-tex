  ...
  return (
    <div>
      ...
      <input
        ...
        className={`mt-2.5 w-full border-b bg-transparent pb-2.5 text-lg text-graphite placeholder:text-graphite-faint/50 transition-colors duration-500 motion-reduce:transition-none focus:outline-none focus-visible:border-thread ${
