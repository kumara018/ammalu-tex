...
export const metadata = {
  ...
  description: 'Cancel within 1 hour of purchase, return within 4 hours of delivery, or exchange within 12 hours of delivery. Strict, verified, Amazon-style policy for Ammalu Tex.',
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="card p-8 space-y-8 text-sm text-graphite-muted leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">1. Order Cancellation — within 1 hour of purchase</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">2. Return (for Refund) — within 4 hours of delivery</h2>
          <div className="space-y-4">
            <div className="p-4 bg-maroon-50 rounded-sm">
              <p className="font-semibold text-graphite mb-2">When can I request a return?</p>
              <ul className="list-disc pl-5 space-y-1 text-graphite-muted">
                <li>The size doesn't fit, <strong>or</strong></li>
                <li>The item arrived damaged.</li>
              </ul>
              <p className="text-graphite-faint text-xs mt-2">These are the only two valid reasons. You'll need to upload 2–3 clear photos of the product as proof — requests without valid proof are rejected.</p>
            </div>
            <div className="p-4 bg-maroon-50 rounded-sm">
              <p className="font-semibold text-graphite mb-2">How it works</p>
              <ol className="list-decimal pl-5 space-y-1 text-graphite-muted">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">3. Exchange / Replacement — within 12 hours of delivery</h2>
          <div className="space-y-4">
            <div className="p-4 bg-maroon-50 rounded-sm">
              <p className="font-semibold text-graphite mb-2">When can I request an exchange?</p>
              <ul className="list-disc pl-5 space-y-1 text-graphite-muted">
                <li>The size doesn't fit, <strong>or</strong></li>
                <li>The item arrived damaged.</li>
              </ul>
              <p className="text-graphite-faint text-xs mt-2">Same two valid reasons as a return, with 2–3 photos as proof — but instead of a refund, you get a replacement.</p>
            </div>
            <div className="p-4 bg-maroon-50 rounded-sm">
              <p className="font-semibold text-graphite mb-2">Choosing your replacement</p>
              <ul className="list-disc pl-5 space-y-1 text-graphite-muted">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">4. How to Request a Cancellation, Return or Exchange</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">5. Not Eligible</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">6. Shipping Charges</h2>
          <ul className="list-disc pl-5 space-y-1">
