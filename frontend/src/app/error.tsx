  ...
  return (
    <div className="relative min-h-[78svh]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[78svh] w-full max-w-[112rem] flex-col justify-center px-6 py-[14vh] sm:px-10">
        <p className="mb-8 text-rule uppercase text-thread">Something went wrong</p>

        <h1 className="max-w-[18ch] font-display text-chapter font-light text-graphite">
          This page did not load
        </h1>

        <p className="mt-8 max-w-[52ch] text-lede text-graphite-muted">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-x-10 gap-y-5">
          <button
            type="button"
            onClick={reset}
            className="group inline-flex items-baseline gap-4 border-b border-thread/70 pb-2 text-caption uppercase text-graphite transition-colors duration-500 hover:border-thread focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-thread"
          >
            Try this page again
          ...
          <Link
            href="/products"
            className="text-caption uppercase text-graphite-faint transition-colors duration-500 hover:text-graphite focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-thread"
          >
            See every piece
          </Link>
        ...
        <div className="mt-[5vh] border-t border-paper-edge/60 pt-8">
          <dl className="grid gap-x-10 gap-y-7 sm:grid-cols-2">
            <div>
              <dt className="text-rule uppercase text-graphite-faint">Speak to us instead</dt>
              <dd className="mt-2.5">
                <a
                  href={`tel:${STORE.phone1}`}
                  className="text-graphite-muted transition-colors hover:text-graphite focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-thread"
                >
                  {STORE.phone1}
                </a>
              </dd>
            ...
            {error.digest && (
              <div>
                <dt className="text-rule uppercase text-graphite-faint">Reference</dt>
                <dd className="mt-2.5 font-mono text-sm tabular-nums text-graphite-muted">
                  {error.digest}
                </dd>
              </div>
            )}
