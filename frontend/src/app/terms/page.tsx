...
export const metadata = {
  ...
  description: 'Terms and Conditions for shopping at Ammalu Tex.',
};
  ...
  return (
    <div className="mx-auto w-full max-w-[68rem] px-6 py-[clamp(3rem,9vh,6rem)] sm:px-10">
      ...
      <div className="card p-8 space-y-8 text-sm text-graphite-muted leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">1. Acceptance of Terms</h2>
          <p>By accessing and using <strong>ammalutex.com</strong> ("the Website"), you accept and agree to be bound by these Terms & Conditions. If you do not agree, please do not use our website or services. These terms apply to all visitors, users, and customers of {STORE.name}.</p>
        </section>

        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">2. Products & Pricing</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">3. Orders & Payments</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">4. Shipping & Delivery</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">5. Cancellation, Return & Exchange</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">6. User Accounts</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">7. Intellectual Property</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">8. Limitation of Liability</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">9. Governing Law</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">10. Changes to Terms</h2>
        ...
        <section>
          <h2 className="text-lg font-normal text-graphite mb-3">11. Contact Us</h2>
